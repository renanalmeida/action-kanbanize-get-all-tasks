...
function getTasks(board, column, apikey, subdomain) {
...
const kanbanizeAPI_1 = __webpack_require__(7230);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            kanbanizeAPI_1.getTasks(board, column, apikey, subdomain)
                .then((response) => {
                let result = '';
